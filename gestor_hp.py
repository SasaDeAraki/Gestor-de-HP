...
def atualizar_imagem_char():
    ...
    # Carrega a imagem de fundo
    bg = Image.open("HP.png")
    draw = ImageDraw.Draw(bg)

    # Fonte
    try:
        font = ImageFont.truetype("C:/Users/sasa/AppData/Local/Microsoft/Windows/Fonts/CocoGothicSmallCaps-Regular.otf", size=36)
    except: 
        font = ImageFont.load_default()
